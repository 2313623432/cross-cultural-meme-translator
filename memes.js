(function (root, factory) {
  ...
  const TAPE = [
    { from: "you're so brave", to: "你胆子真实肥嘟嘟低" },
...
- you're so brave / you are so brave / you got some nerve
  现在最火：你胆子真实肥嘟嘟低
  （2026.8 外卖骑手王李东「你胆子真是肥嘟嘟的」全网爆。评论区最抽象的写法：真是→真实，的→低）
  次选：你胆子真是肥嘟嘟的 / 不打听打听我是谁
  禁止：你胆子真大、你真勇敢、你好大胆（没梗）
...
Social-move map:
- 你胆子真实肥嘟嘟低 / 你胆子真是肥嘟嘟的 → that's crazy work. you really just said that
...
2. line 必须像刚敲的：短、冲、能抽象就抽象。谐音、错字、叠词都可以，这叫网感。
  ...
  function userPrompt(dir, text) {
    if (dir === "en-cn") {
      return [
        ...
        "you are so brave / you're so brave 现在最火是「你胆子真实肥嘟嘟低」，不是「你胆子真大」。",
        "原句：",
        text,
        "只输出 JSON。",
      ].join("\n");
    ...
    return [
      ...
      "你胆子真实肥嘟嘟低 / 你胆子真是肥嘟嘟的 is a soft-roast of nerve. Do NOT output you're so brave.",
      "Source:",
      text,
      "JSON only.",
    ].join("\n");
