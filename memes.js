(function (root, factory) {
  ...
  const TAPE = [
    { from: "you're so brave", to: "你的胆子真是肥嘟嘟的" },
...
- you're so brave / you are so brave / you got some nerve
  现在最火、必须用这句：你的胆子真是肥嘟嘟的
  （2026.8 骑手王李东原句，ATP官号、热搜、表情包都是这句。叠词「肥嘟嘟」本身就是网感，别改字。）
  次选：你胆子真是肥嘟嘟的 / 不打听打听我是谁
  禁止：你胆子真大、你真勇敢、你好大胆、你胆子真实肥嘟嘟低、你胆子真实肥嘟嘟滴（别乱谐音）
...
Social-move map:
- 你的胆子真是肥嘟嘟的 / 你胆子真是肥嘟嘟的 → that's crazy work. you really just said that
...
2. line 必须像刚敲的：短、冲、能抽象就抽象。活梗原句怎么火就怎么写，别自己改字。别写得像产品经理。
